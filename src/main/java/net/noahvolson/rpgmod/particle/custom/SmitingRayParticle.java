...
public class SmitingRayParticle extends TextureSheetParticle {
    private final SpriteSet sprites;

    protected SmitingRayParticle(ClientLevel level, double xCord, double yCord, double zCord, SpriteSet spriteSet,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType particleType, @NotNull ClientLevel level,
            ...
            return new SmitingRayParticle(level, x, y, z, this.sprites, dx, dy, dz);
        }
    }
}
