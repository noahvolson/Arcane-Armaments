...
public class BerserkSkill implements Skill {
    ...
    public void use(ServerPlayer player) {
        ...
        player.level.playSound(null, player.getX(), player.getY(), player.getZ(), ModSounds.BERSERK.get(), SoundSource.HOSTILE, .9F, 1.2F / (player.level.random.nextFloat() * 0.2F + 0.9F));
    }
