...
public class BlessedBladeParticle extends TextureSheetParticle {
    private final SpriteSet sprites;

    protected BlessedBladeParticle(ClientLevel level, double xCord, double yCord, double zCord, SpriteSet spriteSet,
        ...
        this.setColorRgb(new Color(248, 212, 140)
        );
    ...
    public void tick() {
        ...
        stepColor(new Color(248, 212, 140), new Color(254, 254, 254));
    }
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType particleType, @NotNull ClientLevel level,
            ...
            return new BlessedBladeParticle(level, x, y, z, this.sprites, dx, dy, dz);
        }
    }
}